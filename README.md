...
Dependencies:
- Python >=3.10
- Install latest Palworld Save Tools [Palworld Save Tools v0.23.1](https://github.com/cheahjs/palworld-save-tools) with `python -m pip install --upgrade "palworld-save-tools>=0.23.0"`
